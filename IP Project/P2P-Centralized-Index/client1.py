...
def sendfile(rfc_num):
    ...
    rfc_last_modified = time.ctime(os.path.getmtime(filename)) #os.getcwd()+ '\\rfc\\' + txt
    rfc_length = os.path.getsize(filename)    #os.getcwd()+ '\\rfc\\' + txt
    print rfc_length
                ...
                while True: 
                    ...
                    if (usr_ip == 'GET') :
                        ...
                        try:
                            ...
                            filename = os.getcwd() + '\\rfc\\' + rfc_req+ '_' +rfc_req_title + ".txt"
